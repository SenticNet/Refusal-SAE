...
def run_pipeline(model_path):
    ...
    # eval on harmful val (from template dataset)
    harmful_val = random.sample(load_dataset_split(harmtype='harmful', split='val', instructions_only=False), cfg.n_val)
    generate_and_save_completions_for_dataset(cfg, model_base, ablation_fwd_pre_hooks, ablation_fwd_hooks, 'ablation_template', 'ablation', dataset=harmful_val)
